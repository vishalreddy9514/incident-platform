 ...
 * countsByStatus} always contains every {@code IncidentStatus} value as a key, defaulting to 0, so
 * the frontend never has to guard against a missing status when rendering a chart.
 */
